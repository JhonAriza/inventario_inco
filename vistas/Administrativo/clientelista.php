...
if(isset($_POST['consulta']))
{
									...
									$c = new Conexion();
									$cone = $c->conectar();	
									$c = "select * from cliente where nombreCliente LIKE '%$obj->nombreCliente%' ";
...
<html lang="es">
  ...
  <body>
        <form action="" name="clientelista.php"  method="POST">
        <center>
            <h2>clientes desde cliente lista</h2>
            
			<div>
			  <a href="clientelista.php"><input type="button" value="Agregar"></a>	
